...
Revision ID: 6de29cbe3222
Revises: 2d68f9ab1ae2
Create Date: 2023-10-06 21:40:32.777341
...
revision: str = '6de29cbe3222'
down_revision: Union[str, None] = '2d68f9ab1ae2'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_card_pass_id', table_name='card_pass')
...
def downgrade() -> None:
    ...
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('staff', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='card_pass_pkey')
    )
    op.create_index('ix_card_pass_id', 'card_pass', ['id'], unique=False)

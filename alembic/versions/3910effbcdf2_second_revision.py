...
Revision ID: 3910effbcdf2
Revises: eb4f1e1f8048
Create Date: 2023-10-06 19:12:29.423089
...
revision: str = '3910effbcdf2'
down_revision: Union[str, None] = 'eb4f1e1f8048'
...
def downgrade() -> None:
    ...
    sa.Column('CheckedIn', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),

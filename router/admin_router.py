...
from auth.admin_auth import password_hash
from auth.login import get_current_admin, get_user_exceptions
from schemas.schemas import AdminSchema, AdminReadSchema
...
@router.post("/registr", response_model=List[AdminReadSchema])
async def register(admin: AdminSchema,
...
@router.get("/admins-list", response_model=List[AdminReadSchema])
...
@router.get("/{id}", response_model=AdminReadSchema)
...
@router.get("/get-user-me/", response_model=AdminReadSchema)
